...
public class FirstWindow extends JFrame implements ActionListener {
	// default values
	public String element = "X";
	public boolean computer_gegner = false;
	
	public JRadioButton xButton;
	public JRadioButton oButton;
	public JRadioButton manuellButton;
	public JRadioButton computerButton;
	
	public ButtonGroup firstGroup;
	public ButtonGroup secondGroup;
